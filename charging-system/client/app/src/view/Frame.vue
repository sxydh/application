<template>
  ...
  >
    ...
    >
      ...
      >BHE</div>
      <div @click="goto('bhe_aboutMe','/user')" id="bhe_aboutMe" class="bhe_item">About Me</div>
      <div @click="goto('bhe_water','/water')" id="bhe_water" class="bhe_item">Water</div>
      <div @click="goto('bhe_account','/wallet')" id="bhe_account" class="bhe_item">Account</div>
    ...
    >
      ...
      <div
        id="bhe_content"
        style="position: relative; margin-top: 20px; padding: 30px; width: auto; padding-top: 20px;"
      >
