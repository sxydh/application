...
public class FragmentWaterLog extends Fragment {
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.water_log, container, false);

        textView = root.findViewById(R.id.bhe_water_log_text);

        swipeRefreshLayout = root.findViewById(R.id.bhe_water_log);
    ...
    public void refresh() {
        ...
        }.execute(Load.instance("/water/log/list").put("offset", 0).put("limit", 100));
    }
